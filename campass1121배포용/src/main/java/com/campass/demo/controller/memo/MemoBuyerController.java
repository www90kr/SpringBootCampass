...
@RestController
public class MemoBuyerController {
	@Autowired
	private MemoService service;
	
	// 메모 보내기
	@PostMapping("/buyer/memos/new")
	...
	// 전체 메모 보내기 -> 메모를 보낸 다음 보낸 메모 페이지로 이동
	@PostMapping("/buyer/memos/allcheck") 
	...
	// 보낸 쪽에서 메모 삭제
	@DeleteMapping("/buyer/memos/send") 
	...
	// 받은 쪽에서 메모 삭제
	@DeleteMapping("/buyer/memos/receive") 
